...
import 'customer_update_profile_page_widget.dart'
...
class CustomerUpdateProfilePageModel
    extends FlutterFlowModel<CustomerUpdateProfilePageWidget> {
  ...
  // State field(s) for UpdateCustomerShopLocation widget.
  FocusNode? updateCustomerShopLocationFocusNode;
  TextEditingController? updateCustomerShopLocationTextController;
  String? Function(BuildContext, String?)?
  ...
  void dispose() {
    ...
    updateCustomerShopLocationFocusNode?.dispose();
    updateCustomerShopLocationTextController?.dispose();
  }
}
