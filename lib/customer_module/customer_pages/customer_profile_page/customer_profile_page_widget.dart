    ...
    return StreamBuilder<List<CustomerRecord>>(
      stream: queryCustomerRecord(
        queryBuilder: (customerRecord) => customerRecord.where(
          'email',
          isEqualTo: widget!.customerEmail,
        ),
        singleRecord: true,
      ),
      builder: (context, snapshot) {
        ...
        List<CustomerRecord> customerProfilePageCustomerRecordList =
            snapshot.data!;
        // Return an empty Container when the item does not exist.
        if (snapshot.data!.isEmpty) {
          return Container();
        }
        final customerProfilePageCustomerRecord =
            customerProfilePageCustomerRecordList.isNotEmpty
                ? customerProfilePageCustomerRecordList.first
                : null;
                    ...
                    children: [
                      Material(
                        ...
                        child: Container(
                          ...
                          child: ClipRRect(
                            borderRadius: BorderRadius.circular(75.0),
                            child: Image.network(
                              customerProfilePageCustomerRecord!.photoUrl,
                              width: 150.0,
                              height: 150.0,
                              fit: BoxFit.contain,
                            ),
                      ...
                      Text(
                        valueOrDefault<String>(
                          customerProfilePageCustomerRecord?.displayName,
                          'null',
                        ),
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                          valueOrDefault<String>(
                                            customerProfilePageCustomerRecord
                                                ?.email,
                                            'null',
                                          ),
                                          style: FlutterFlowTheme.of(context)
                                    ...
                                    InkWell(
                                      ...
                                      onTap: () async {
                                        context.pushNamed(
                                          ...
                                          queryParameters: {
                                            'customerReference': serializeParam(
                                              customerProfilePageCustomerRecord
                                                  ?.reference,
