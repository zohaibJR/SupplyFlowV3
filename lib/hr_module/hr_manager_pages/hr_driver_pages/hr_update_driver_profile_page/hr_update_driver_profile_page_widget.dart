...
import 'hr_update_driver_profile_page_model.dart';
export 'hr_update_driver_profile_page_model.dart';

class HrUpdateDriverProfilePageWidget extends StatefulWidget {
  const HrUpdateDriverProfilePageWidget({
    super.key,
  ...
  @override
  State<HrUpdateDriverProfilePageWidget> createState() =>
      _HrUpdateDriverProfilePageWidgetState();
}

class _HrUpdateDriverProfilePageWidgetState
    extends State<HrUpdateDriverProfilePageWidget> {
  late HrUpdateDriverProfilePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HrUpdateDriverProfilePageModel());
    ...
    _model.inputDriverExperienceFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<DriverRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final hrUpdateDriverProfilePageDriverRecord = snapshot.data!;
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                _model.uploadedFileUrl != null &&
                                    ...
                                    ? _model.uploadedFileUrl
                                    : hrUpdateDriverProfilePageDriverRecord
                                        .photoUrl,
                                width: 190.0,
                                height: 190.0,
                                fit: BoxFit.contain,
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: TextFormField(
                                      controller: _model
                                              .inputDriverExperienceTextController ??=
                                          TextEditingController(
                                        text:
                                            hrUpdateDriverProfilePageDriverRecord
                                                .driverExperience,
                                      ...
                                      focusNode:
                                          _model.inputDriverExperienceFocusNode,
                                      onChanged: (_) => EasyDebounce.debounce(
                                        '_model.inputDriverExperienceTextController',
                                        Duration(milliseconds: 2000),
                                        () => safeSetState(() {}),
                                      ),
                                      autofocus: false,
                                      ...
                                      await showDialog(
                                        ...
                                        builder: (alertDialogContext) {
                                          return AlertDialog(
                                            ...
                                            content: Text(
                                                'Driver Details have been Updated'),
                                            actions: [
                                              TextButton(
