...
import 'hr_update_supplier_profile_page_model.dart';
export 'hr_update_supplier_profile_page_model.dart';

class HrUpdateSupplierProfilePageWidget extends StatefulWidget {
  const HrUpdateSupplierProfilePageWidget({
    super.key,
  ...
  @override
  State<HrUpdateSupplierProfilePageWidget> createState() =>
      _HrUpdateSupplierProfilePageWidgetState();
}

class _HrUpdateSupplierProfilePageWidgetState
    extends State<HrUpdateSupplierProfilePageWidget> {
  late HrUpdateSupplierProfilePageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HrUpdateSupplierProfilePageModel());
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<SuppliersRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final hrUpdateSupplierProfilePageSuppliersRecord = snapshot.data!;
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                _model.uploadedFileUrl != null &&
                                    ...
                                    ? _model.uploadedFileUrl
                                    : hrUpdateSupplierProfilePageSuppliersRecord
                                        .photoUrl,
                                width: 190.0,
                                height: 190.0,
                                fit: BoxFit.contain,
                                ...
                                children: [
                                  ...
                                  FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await widget!.supplierReference!
                                          .update(createSuppliersRecordData(
                                        displayName: _model
